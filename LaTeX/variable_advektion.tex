...
\vspace{0.4cm}
\lstinputlisting[firstnumber=53, firstline=53, lastline=59]{../Programme/variable_advection.m}
...
\lstinputlisting[firstnumber=12, linerange={12-19}]{../Programme/variable_advection.m}
\lstinputlisting[firstnumber=34, linerange={39-43}]{../Programme/variable_advection.m}
...
\addplot[myblue] table {../Programme/output/a.dat};
\addplot[mygreen] table [y index= 131] {../Programme/output/u.dat};
...
\addplot[myblue] table {../Programme/output/a.dat};
\addplot[mygreen] table [y index= 164] {../Programme/output/u.dat};
...
\addplot[myblue] table {../Programme/output/a.dat};
\addplot[mygreen] table [y index= 261] {../Programme/output/u.dat};
...
\addplot[myblue] table {../Programme/output/a.dat};
\addplot[mygreen] table [y index= 280] {../Programme/output/u.dat};
