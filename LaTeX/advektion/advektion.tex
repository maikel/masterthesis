...
Die Gleichung \eqref{eq:adv:osz:o1} lautet nun
\[
\bigl( - \lambda \bigr) \cdot \bigl( \partial_t u_0(t_n, x_i) + \partial_x u_0(t_n, x_i) \bigr) = 
\Bigl[ \theta(n+1,i) - \theta(n,i) +
\lambda \bigl( \theta(n, i) - \theta(n, i-1) \bigr) \Bigr] \cdot \Psi(t_n, x_i).
\]