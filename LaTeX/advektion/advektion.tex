...
\begin{lemma}[Konstanz auf der Diagonalen]
...
% Diese kommt daher, dass die Punkte $(t^h_n, x^h_i)$ in unserem Gitter immer in einem rationalem Verhältnis stehen.
Dies kommt daher, weil wir in $h$ nur eine Variable haben, mit der wir unser äquidistantes Gitter variieren können.
% Daher brauchen wir ein Grenzwertargument für $h \to 0$, um Aussagen über alle Punkte $(t,x)$ in der Raumzeit zu treffen.
\begin{proof}
