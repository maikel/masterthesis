...
und somit folgt unter Verwendung die Rechnung
\begin{align}
\begin{split}
...
&\quad - (-1)^{i+n} h^3 \left( \partial_t z_2 + \partial_t z_1 + 2 \partial_\tau z_1 + \frac{1}{2} \partial^2_t z_1\\
&\qquad + 2 \partial_\tau z_0 + \partial^2_t z_0+ \frac{1}{6} \partial^3_t z_0 \right) + O(h^4)\\
\end{split}
\end{align}
aber auch
\begin{align}
