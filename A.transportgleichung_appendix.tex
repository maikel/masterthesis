...
&\quad - (-1)^{i+n} \left( 2 z_0 + h 2 z_1 + h^3 2 z_2 \right)\\
...
&\quad + (-1)^{i+n} \left( 2 z_0 + h 2 z_1 + h^2 z_2 \right)\\
...
\end{split}
\end{align}
Für jede Ordnung in $h$ erhalten wir mit Hilfe des Satzes \ref{satz:alt:beidenull} je für den glatten Anteil $w$ und auch oszillierenden Anteil $z$ eine Gleichung.
Mit einem Stetigkeitsargument und wegen der Dichtheit von $\bigcup_{h > 0} G_h$ gilt für alle $(t,\tau,x)$
\begin{align}\label{eq:apx:fuerw}
\partial_t w_0 + \partial_x w_0 &= 0\\ 
\partial_t w_1 + \partial_x w_1 + \underbrace{\partial_t w_0 + \partial_x w_0}_{= 0} &= \underbrace{\frac{1}{2} \partial^2_x w_0 - \frac{1}{2} \partial^2_t w_0}_{= 0}
\end{align}
