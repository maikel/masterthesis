...
\end{split}
\end{align}
In erster Ordnung von $h$ gilt also
\begin{align}
...
\end{split}
\end{align}
% Wir betrachten wieder den Multiskalenansatz $u(t,\tau,x)$ mit einer langsamen Zeitvariablen $\tau = h t$.
% Wie schon gewohnt erhalten wir das Gleichungssystem
% \begin{align}\label{eq:wkb:oh11}
