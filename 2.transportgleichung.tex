...
\partial_t u(t, x) + \partial_x u(t, x) = 0, \quad u(0, x) = U(x) \text{ und $(t,x) \in \Rp \times \R$.}
\end{align}
Auf diese partielle Differentialgleichung wenden wir das Upwind-Verfahren mit dem Gitter $G_h(n,i) = (t_n, x_i) = h \cdot (\lambda n, i) \subset \Rp \times \R$ f"ur $\lambda, h > 0$ und $n\in \N, i \in \Z$ an.
...
\end{align}
bestimmt.
Es ist bereits bekannt, dass das Verfahren f"ur $\lambda \leq 1$ stabil und f"ur $\lambda = 1$ sogar exakt ist (siehe auch \cite{leveque2002finite}).
