...
\end{align}
Wegen der Gleichung \eqref{eq:3_1:u01} und \eqref{eq:3_1:u02} folgt f"ur alle $t$ und $\tau \in \R$
\begin{align}
u_0(t, \tau, x) &= u_0(0, \tau, x-t)\\
u_0(t, \tau, x) &= u_0(t, 0, \Phi(-\tau, x) ),
\end{align}
f"ur den Fluss $\Phi \in C^\infty\left(\Rp \times \R \right)$ der Differentialgleichung $\dot x = b(x)$.
