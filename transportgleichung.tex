...
\end{align}
gilt, so folgt auch $z_2 = 0$. Gleichung \eqref{eq:ke:addiff} ist eine Advektion-Diffusion Gleichung und bedeutet, dass $z_0$ entlang von Geraden advektiert und diffundiert wird.
Diese Gleichung ist wohl gestellt, weil $\frac{7}{2} > 0$ gilt.
