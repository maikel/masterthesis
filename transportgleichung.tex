...
\begin{align} \label{eq:ke:addiff}
\partial_{\tau_2} z_0 + 16 \partial_x z_0 = \frac{28}{3} z_0 + \frac{7}{2} \partial^2_x z_0
\end{align}
...
\end{split}\end{align}
Hierauf können wir wieder Satz \ref{satz:glgregulaer} anwenden und bekommen das für $w_0$ und $z_0$ das Gleichungssystem
\begin{align}\label{eq:exp:oh}
\partial_t w_0(t,x) + \partial_x w_0(t,x) &= 0 &w_0(0,x) &= U(x) \quad \text{und}\\
\partial_t z_0(t,x) + e^{i (\theta - \omega)} \partial_x z_0(t,x) &= 0 &z_0(0,x) &= V(x) 
\end{align}