...
\begin{split}
\partial_t z_2(t,x) + \partial_x z_2(t,x) &= 2 z_2(t,x) - \left( 2 \bigl( \partial_\tau z_0(t,x) + \partial^2_\tau z_0(t,x) \bigr)\\
&\quad + \frac{1}{2} (2\partial^2_t z_0(t,x) - \partial^2_x z_0(t,x)) + \frac{1}{6} \bigl(\partial^3_t z_0(t,x) + \partial^3_x z_0(t,x)\bigr) \right)
\end{split}
\end{align}
